...
wget https://raw.githubusercontent.com/Cyber-ssh/webv1/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/webv1/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/webv1/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/webv1/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/Cyber-ssh/webv1/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/Cyber-ssh/webv1/main/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/Cyber-ssh/webv1/main/chave") &>/dev/null
